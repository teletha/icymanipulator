 ...
 */
public abstract class GenericVariable<Value1, Value2> extends GenericVariableModel<Value1, Value2> implements Manipulatable<GenericVariable<Value1, Value2>> {
     ...
     */
      ...
      * Model Manipulator.
      */
     public static final class Manipulator<RootModel, Value1, Value2> extends icy.manipulator.Manipulator<RootModel,GenericVariable<Value1, Value2>> {

         /** The accessor for value1 property. */
         private static final Accessor VALUE1 = Accessor.<GenericVariable, Object> of(GenericVariable::value1,  GenericVariable::value1);

         /** The accessor for value2 property. */
         private static final Accessor VALUE2 = Accessor.<GenericVariable, Box> of(GenericVariable::value2,  GenericVariable::value2);

         /** The accessor for nestedValue2 property. */
         private static final Accessor NESTEDVALUE2 = Accessor.<GenericVariable, Box> of(GenericVariable::nestedValue2,  GenericVariable::nestedValue2);
