...
/**
 * {@link Manipulatable} model for {@link IntercepteSetterModel}.
 */
public abstract class IntercepteSetter extends IntercepteSetterModel implements Manipulatable<IntercepteSetter> {

     /** The final property updater. */
     private static final java.lang.invoke.MethodHandle textUpdater = icy.manipulator.Manipulator.updater(IntercepteSetterModel.class, "text");

     /** The final property updater. */
     private static final java.lang.invoke.MethodHandle upperUpdater = icy.manipulator.Manipulator.updater(IntercepteSetterModel.class, "upper");

     /** The final property updater. */
     private static final java.lang.invoke.MethodHandle sizeUpdater = icy.manipulator.Manipulator.updater(IntercepteSetterModel.class, "size");
