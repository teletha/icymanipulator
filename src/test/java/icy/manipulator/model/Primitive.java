...
public abstract class Primitive extends PrimitiveModel implements Manipulatable<Primitive> {
     ...
     */
     ...
     public static final class Manipulator<RootModel> extends icy.manipulator.Manipulator<RootModel,Primitive> {
         ...
         private static final Accessor INTVALUE = Accessor.<Primitive, Integer> of(Primitive::intValue,  Primitive::intValue);

         /** The accessor for longValue property. */
         private static final Accessor LONGVALUE = Accessor.<Primitive, Long> of(Primitive::longValue,  Primitive::longValue);

         /** The accessor for floatValue property. */
         private static final Accessor FLOATVALUE = Accessor.<Primitive, Float> of(Primitive::floatValue,  Primitive::floatValue);

         /** The accessor for doubleValue property. */
         private static final Accessor DOUBLEVALUE = Accessor.<Primitive, Double> of(Primitive::doubleValue,  Primitive::doubleValue);

         /** The accessor for booleanValue property. */
         private static final Accessor BOOLEANVALUE = Accessor.<Primitive, Boolean> of(Primitive::booleanValue,  Primitive::booleanValue);

         /** The accessor for charValue property. */
         private static final Accessor CHARVALUE = Accessor.<Primitive, Character> of(Primitive::charValue,  Primitive::charValue);

         /** The accessor for byteValue property. */
         private static final Accessor BYTEVALUE = Accessor.<Primitive, Byte> of(Primitive::byteValue,  Primitive::byteValue);
