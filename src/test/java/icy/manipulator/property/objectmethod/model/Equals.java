...
/**
 * Generated model for {@link EqualsModel}.
 */
@Generated("Icy Manipulator")
public abstract class Equals extends EqualsModel {
    ...
    private static final MethodHandle updater(String name)  {
        try {
            Field field = Equals.class.getDeclaredField(name);
    ...
    public String toString() {
        StringJoiner builder = new StringJoiner(", ", "Equals [", "]");
     ...
     * Property assignment API.
     */
    public static interface ÅssignableÅrbitrary<Next extends Equals> {
    }
     ...
     * Mutable Model.
     */
    private static final class Åssignable extends Equals implements ÅssignableAll, ÅssignableÅrbitrary {
    }
