...
public class ArbitraryOverload extends ArbitraryOverloadModel {
    ...
    private static final MethodHandle invoker(String name, Class... parameterTypes)  {
        try {
            Method method = icy.manipulator.property.overload.model.ArbitraryOverloadModel.class.getDeclaredMethod(name, parameterTypes);
    ...
    public static class Ìnstantiator<Self extends ArbitraryOverload & ÅssignableÅrbitrary<Self>> {
        ...
        public Self size(String number) {
            try {
                return size((int) size$927011984.invoke(create(), number));
            } catch (Throwable e) {
                throw quiet(e);
            }
        }
