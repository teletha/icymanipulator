...
public abstract class MultiIntercepts extends MultiInterceptsModel {
    ...
    private static final MethodHandle checkLower$1806562800= invoker("checkLower", int.class);

    /** The overload or intercept method invoker. */
    private static final MethodHandle stringlize$414537721= invoker("stringlize", int.class, Consumer.class);
    ...
    private final void setSize(int value) {
        try {
            sizeUpdater.invoke(this, stringlize$414537721.invoke(this, checkLower$1806562800.invoke(this, value), (Consumer<String>) ((Åssignable) this)::value));
        } catch (Throwable e) {
            throw quiet(e);
        }
    }
