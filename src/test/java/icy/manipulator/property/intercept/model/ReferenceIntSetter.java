...
public abstract class ReferenceIntSetter extends ReferenceIntSetterModel {
    ...
    private static final MethodHandle deriveBySize$1155388000= invoker("deriveBySize", int.class, IntConsumer.class);
    ...
    private final void setSize(int value) {
        try {
            sizeUpdater.invoke(this, deriveBySize$1155388000.invoke(this, value, (IntConsumer) ((Åssignable) this)::square));
        } catch (Throwable e) {
            throw quiet(e);
        }
    }
