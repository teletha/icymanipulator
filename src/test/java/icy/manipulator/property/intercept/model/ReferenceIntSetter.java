...
public abstract class ReferenceIntSetter extends ReferenceIntSetterModel {
    ...
    private static final MethodHandle deriveBySize$1233409856= invoker("deriveBySize", int.class, IntConsumer.class);
    ...
    private final void setSize(int value) {
        try {
            sizeUpdater.invoke(this, deriveBySize$1233409856.invoke(this, value, (IntConsumer) ((Åssignable) this)::square));
        } catch (Throwable e) {
            throw quiet(e);
        }
    }
