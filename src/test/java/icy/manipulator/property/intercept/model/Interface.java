...
public abstract class Interface implements InterfaceModel {
    ...
    private static final MethodHandle normalizeSize$452627123= invoker("normalizeSize", int.class);
    ...
    private final void setSize(int value) {
        try {
            sizeUpdater.invoke(this, normalizeSize$452627123.invoke(this, value));
        } catch (Throwable e) {
            throw quiet(e);
        }
    }
