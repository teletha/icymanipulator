...
public abstract class Intercept extends InterceptModel {
    ...
    private static final MethodHandle normalizeSize$1325436563= invoker("normalizeSize", int.class);
    ...
    private final void setSize(int value) {
        try {
            sizeUpdater.invoke(this, normalizeSize$1325436563.invoke(this, value));
        } catch (Throwable e) {
            throw quiet(e);
        }
    }
