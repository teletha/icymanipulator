...
public abstract class ReferenceLongSetter extends ReferenceLongSetterModel {
    ...
    private static final MethodHandle deriveBySize$222306272= invoker("deriveBySize", int.class, LongConsumer.class);
    ...
    private final void setSize(int value) {
        try {
            sizeUpdater.invoke(this, deriveBySize$222306272.invoke(this, value, (LongConsumer) ((Åssignable) this)::square));
        } catch (Throwable e) {
            throw quiet(e);
        }
    }
