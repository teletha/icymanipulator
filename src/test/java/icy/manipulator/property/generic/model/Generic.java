...
public class Generic<P, Q extends Number> implements GenericModel<P, Q> {
    ...
    public static class Ìnstantiator<Self extends Generic<P, Q> & ÅssignableÅrbitrary<Self, P, Q>, P, Q extends Number> {
         ...
         */
        public ÅssignableNumber<ÅssignableMapper<ÅssignableList<Self, P, Q>, P, Q>, P, Q> value(P value) {
     ...
     * Property assignment API.
     */
    public static interface ÅssignableList<Next, P, Q extends Number> {
     ...
     */
    protected static interface ÅssignableAll extends ÅssignableValue, ÅssignableNumber, ÅssignableMapper, ÅssignableList {
    }
