...
public class ThrowOriginalError extends ThrowOriginalErrorModel {
    ...
    private static final MethodHandle invoker(String name, Class... parameterTypes)  {
        try {
            Method method = icy.manipulator.property.error.model.ThrowOriginalErrorModel.class.getDeclaredMethod(name, parameterTypes);
    ...
    private static final MethodHandle validateSize$101354429= invoker("validateSize", int.class);
    ...
    private final void setSize(int value) {
        try {
            if (NATIVE) {
                sizeField.setInt(this, (int) validateSize$101354429.invoke(this, value));
            } else {
    ...
    public boolean equals(Object o) {
        if (o instanceof ThrowOriginalError == false) {
            return false;
        }
