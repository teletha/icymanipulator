...
public abstract class ThrowOriginalError extends ThrowOriginalErrorModel {
    ...
    private static final MethodHandle validateSize$2068949041= invoker("validateSize", int.class);
    ...
    private final void setSize(int value) {
        try {
            sizeUpdater.invoke(this, validateSize$2068949041.invoke(this, value));
        } catch (Throwable e) {
            throw quiet(e);
        }
    }
